...
@section('body')
    <div class="row">
        <div class="col-md-12">
            <div class="ibox mt-3">
                <div class="ibox-head">
                    <div class="ibox-title"> Case Dismiss Form</div>
                ...
                <div class="ibox-body">
                    ...
                    @endif
                    <form class="form-horizontal" action="{{route('request-dismiss', ['id' => $case->id])}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            <div class="col-sm-10 ml-sm-auto">
                                <button class="btn btn-warning btn-block" type="submit">Request to Dismiss Case</button>
                            </div>
                        </div>
                    </form>
                </div>
